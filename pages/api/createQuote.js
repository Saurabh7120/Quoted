...
export default async function handler(req, res) {
    try {
      ...
      const docRef = await addDoc(collectionRef, {...body, likes:{} , created_on: Timestamp.fromDate(new Date())});
      ...
      res.status(200).json({...updatedDoc, created_on: updatedDoc.created_on.toDate()});
    } catch (error) {
